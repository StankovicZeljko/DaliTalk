...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            description = itemView.findViewById(R.id.listElementDesc);
            task = itemView.findViewById(R.id.listElementTask);
            imageView = itemView.findViewById(R.id.listElementImageView);
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_item_list_element, parent, false));
    }
